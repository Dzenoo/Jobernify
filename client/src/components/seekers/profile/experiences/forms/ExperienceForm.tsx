...
const ExperienceForm: React.FC<ExperienceFormProps> = ({
  ...
  const form = useForm<zod.infer<typeof SchemaToInfer>>({
    ...
    defaultValues: {
      jobTitle: isEdit ? jobTitle : "",
      companyName: isEdit ? companyName : "",
      startDate: isEdit ? new Date(startDate) : new Date(),
      endDate: isEdit ? new Date(endDate) : new Date(),
      level: isEdit ? (level as any) : "",
      type: isEdit ? (type as any) : "",
      position: isEdit ? (position as any) : "",
      location: isEdit ? location : "",
      isCurrentlyWorking: isEdit ? isCurrentlyWorking : false,
    },
    mode: "all",
  });
